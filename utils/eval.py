...
if __name__ == '__main__':
    source = '/home/linzhe/document-level-paraphrase/data/key2self/test.sent.comb'
    target = '/home/linzhe/document-level-paraphrase/self_key2/data/output/result.txt.combine'
    # source = '/home/linzhe/document-level-paraphrase/data/document_data/test.src'
    # target = '/home/linzhe/document-level-paraphrase/data/document_data/test.tgt'
    eval = Eval(source)
    eval(target)
